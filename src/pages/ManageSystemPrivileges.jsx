        ...
        <div className="px-4">
          ...
          <div className="flex gap-4  flex-wrap md:flex-nowrap w-full">
            ...
            <div className="left flex flex-col gap-4 max-md:w-full">
                  ...
                  <form>
                    <div className="mb-4">
                      <div className="mb-3">
                        ...
                        <select className="px-4 w-full text-[14px] text-gray-700  placeholder:text-sm py-1.5 rounded border-gray-300 focus:border focus:border-violet-500 focus:ring-0  border  outline-none ">
              ...
              <div className="card   border-gray-300 border p-4  rounded-lg overflow-hidden ">
                <div className="card-body ">
                  <div className="search-box">
                    <h5 className="mb-3 text-gray-700  text-lg">
                      Rechercher un role précis
                    </h5>
                    <div className="px-4 w-full placeholder:text-sm  rounded border-gray-300 focus:border focus:border-violet-500 focus:ring-0  border  flex justify-center items-center outline-none">
              ...
              <div className="card  border   rounded-lg overflow-hidden  ">
                ...
                <div className="card-body   rounded-lg p-4">
                  ...
                  <p className="card-text text-gray-600 text-[14px]">
                  ...
                  <div className="mt-6">
                    ...
                    >
                      <CiCircleRemove className="text-[18px]" />
            ...
            <div className="mb-0 w-full">
              <div className="card-body border-[#e5e7eb] border w-full  rounded-lg p-4">
...
export default ManageSystemPrivileges;
