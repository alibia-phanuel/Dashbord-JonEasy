    ...
    <div className="w-full  flex">
      ...
      <div className="h-screen flex  flex-col w-[calc(100%-4rem)] ">
        ...
        <div className="px-4">
          ...
          <div className="gap-4  justify-center flex  flex-wrap md:flex-nowrap">
            {/**  <!--Contenu d'enegistrement de données--> */}
            <div className="flex flex-col gap-4 max-md:w-full  max-w-md:bg-red-900">
              <div className="border-[#e5e7eb] border rounded-lg    flex flex-col gap-5 p-4">
                <div className="card-body pb-0">
                  <div className="flex flex-row item-center space-x-2">
                    ...
                    />
                    <h4 className="text-sm pt-1 text-gray-700 ">
                      Nouveau role{" "}
                ...
                <div className="card-body">
                  <form>
                    <div className="mb-4">
                      ...
                      <input
                        className="px-4 w-full placeholder:text-sm py-1.5 rounded border-gray-200   focus:border focus:border-violet-500 focus:ring-0  border  outline-none"
                        type="text"
                        id="default-input"
                    ...
                    <div className="mb-4">
                      <label
                        className="block font-medium text-[14px] text-gray-700  mb-2"
                        htmlFor="default-input"
                      >
                        Description traductible du rôle
                      </label>
                      <textarea
                        className="px-4 w-full h-14 resize-none placeholder:text-sm py-1.5 rounded  focus:border focus:border-violet-500 border-gray-200  border focus:ring-0   outline-none "
                        type="text"
                        id="default-input"
                        placeholder="Se referer au manifest. Feuille Gestion Privilèges"
                      ></textarea>
            ...
            <div className="mb-0  border-[#e5e7eb] border    rounded-lg p-4 w-[80%]">
              <div className="card-body">
